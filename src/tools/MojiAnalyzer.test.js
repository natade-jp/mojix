...
test_count = 0;
{
	...
	testType(Unicode.toUTF32Array("あ゙")[1], "is_grapheme_component", true);
	testType("あ", "is_grapheme_component", false);
	testType("​", "is_zero_width_character", true);
	testType("\t", "is_zero_width_character", false);
